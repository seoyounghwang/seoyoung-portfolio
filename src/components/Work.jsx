...
import SamuraiPizzaImg from "../assets/samuraiPizza.JPG";
    ...
    <div name="work" className="w-full md:h-screen text-white bg-[#154024]">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div
            style={{ backgroundImage: `url(${SamuraiPizzaImg})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center itmes-center mx-auto content-div"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
              <div className="justify-center items-center flex-col pt-7 text-center">
                <span className="text-2xl font-bold text-white tracking-wider justify-center items-center">
                  MERN TypeScript GraphQL
                </span>
                <p className="text-1xl font-bold text-white tracking-wider justify-center">
                  Samurai Pizza Application
                </p>
                <div className="pt-8 text-center">
                  <a
                    href="https://github.com/seoyounghwang/Samurai-Pizza-Cats-seoyounghwang"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
